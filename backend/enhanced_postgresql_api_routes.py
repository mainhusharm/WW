...
Direct connection to PostgreSQL: postgresql://pghero_dpg_d37pd8nfte5s73bfl1ug_a_y6fl_user:hyVL0yZEuw6EyIOKXs4nS5nTFmR1Sg5j@dpg-d596prv5r7bs73938m2g-a.oregon-postgres.render.com/pghero_dpg_d37pd8nfte5s73bfl1ug_a_y6fl
"""
    ...
    try:
        ...
        dashboard_query = """
            INSERT INTO user_dashboard_data (
                id, user_id, questionnaire_id, prop_firm, account_type, account_size,
...
def get_dashboard_data(user_email):
    ...
    try:
        ...
        dashboard_overview = db.execute_query_single(
            "SELECT * FROM dashboard_overview WHERE user_id = %s",
            (user_profile['id'],)
        )
