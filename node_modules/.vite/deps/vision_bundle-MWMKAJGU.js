...
function Br(t2, e2, n2) {
  ...
  if (256 & r2) {
    r2 = t2[s2 - 1];
    for (let t3 in r2)
      i2 = +t3, !Number.isNaN(i2) && (null != (s2 = r2[t3]) && (a2 = Dr(n2, i2))) && ((o2 = n2.X)?.[i2] && !o2?.P?.[i2] && Wr++ < 5 && j(), a2(e2, s2, i2));
  }
...
function Lo(t2) {
  ...
  if ((e2 = pn(t2, is, 4)?.h()) && (s2.boundingBox = { originX: An(e2, 1) ?? 0, originY: An(e2, 2) ?? 0, width: An(e2, 3) ?? 0, height: An(e2, 4) ?? 0, angle: 0 }), pn(t2, is, 4)?.g().length)
...
var Qo = class {
  ...
  l(t2, e2 = true) {
    if (e2) {
      ...
      if (!(pn(this.baseOptions, Ss, 1)?.g() || pn(this.baseOptions, Ss, 1)?.h() || t2.baseOptions?.modelAssetBuffer || t2.baseOptions?.modelAssetPath))
...
var yh = class extends Za {
  ...
  o(t2) {
    if (xn(this.v, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Ln(this.v, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Ln(this.s, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Ln(this.C, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      ...
      void 0 === t2.cannedGesturesClassifierOptions && pn(this.h, Hs, 3)?.g();
...
//# sourceMappingURL=vision_bundle-MWMKAJGU.js.map
