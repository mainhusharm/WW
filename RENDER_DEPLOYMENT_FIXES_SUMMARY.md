...
CORS_ORIGINS=https://your-frontend-domain.com,https://localhost:5173,https://backend-ox9b.onrender.com
```
...
### **Backend Service:**
- **URL**: `https://backend-ox9b.onrender.com`
- **Health Check**: `https://backend-ox9b.onrender.com/healthz`
- **API Base**: `https://backend-ox9b.onrender.com/api`
