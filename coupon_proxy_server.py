...
def validate_coupon():
    ...
    try:
        ...
        # Handle private coupon - Freetrial100 provides 100% discount
        if coupon_code == 'Freetrial100':
            discount_amount = original_price
            final_price = 0.00
            print(f"Freetrial100 coupon applied: discount=${discount_amount}, final_price=${final_price}")
            return jsonify({
                'valid': True,
                'discount_amount': discount_amount,
                'final_price': final_price,
                'message': 'Free trial coupon applied!'
            }), 200
        else:
