...
try:
    ...
    app = Flask(__name__, static_folder='dist', static_url_path='/') # Serve static files from 'dist'
    ...
    @app.route('/')
    def serve_index():
        return send_from_directory(app.static_folder, 'index.html') # Serve index.html for root
    
    @app.errorhandler(404)
    def not_found(e):
        return send_from_directory(app.static_folder, 'index.html') # SPA fallback
