...
const CombinedMembershipPlans: React.FC = () => {
  ...
  const handlePlanSelect = (plan: any, type: 'trading' | 'mt5') => {
    ...
    if (type === 'mt5') {
      ...
      window.location.href = `/signup?plan=${plan.id}&price=${plan.price}&discountedPrice=${plan.discountedPrice || ''}&period=${plan.period}&type=trading`;
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-24 max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              See how TraderEdge Pro compares to standard signal groups and delivers superior results.
            </p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-white/[0.1]">
                    ...
                    <th className="text-center p-6 text-gray-400 font-medium">Standard Signal Groups</th>
                    <th className="text-center p-6 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-l border-r border-cyan-500/20">
                      <div className="text-cyan-400 font-bold">TraderEdge Pro</div>
                      <div className="text-xs text-cyan-300/60 mt-1">AI-Powered Platform</div>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-white/[0.05]">
                    <td className="p-6 text-white/90 font-medium">Signal Generation</td>
                    <td className="p-6 text-center text-gray-400">Manual analysis, delayed signals</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">AI-powered real-time analysis</td>
                  </tr>
                  <tr className="border-b border-white/[0.05]">
                    <td className="p-6 text-white/90 font-medium">Risk Management</td>
                    <td className="p-6 text-center text-gray-400">No automated risk controls</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">Automatic risk guards & stop-loss</td>
                  </tr>
                  <tr className="border-b border-white/[0.05]">
                    <td className="p-6 text-white/90 font-medium">Success Rate</td>
                    <td className="p-6 text-center text-gray-400">~30-50% typical performance</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">94% challenge clearance rate</td>
                  </tr>
                  <tr className="border-b border-white/[0.05]">
                    <td className="p-6 text-white/90 font-medium">24/7 Support</td>
                    <td className="p-6 text-center text-gray-400">Limited community support</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">AI Nexus Coach + human support</td>
                  </tr>
                  <tr className="border-b border-white/[0.05]">
                    <td className="p-6 text-white/90 font-medium">Educational Tools</td>
                    <td className="p-6 text-center text-gray-400">Basic trading education</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">Advanced analytics & backtesting</td>
                  </tr>
                  <tr>
                    <td className="p-6 text-white/90 font-medium">Cost</td>
                    <td className="p-6 text-center text-gray-400">$50-200/month</td>
                    <td className="p-6 text-center text-cyan-400 font-semibold bg-gradient-to-r from-cyan-500/5 to-blue-500/5">$49-499/month (ROI focused)</td>
                  </tr>
                </tbody>
              </table>
            </div>
