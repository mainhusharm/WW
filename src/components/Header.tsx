  ...
  return (
    <header className={`fixed top-6 left-1/2 transform -translate-x-1/2 z-20
      ...
      <div className="flex items-center justify-between w-full gap-x-4 sm:gap-x-6">
        {/* Logo */}
        <Link to="/" className="flex items-center space-x-2 group px-6 py-2 min-w-[280px]">
          <div className="relative">
            <img
              src="/logo.png"
              alt="TraderEdge Pro Logo"
        ...
        <div className="hidden sm:flex items-center gap-2 sm:gap-3">
          <Link
            to="/signin"
            className="px-6 py-2 text-sm border border-white/30 text-gray-300 rounded-full hover:border-white/50 hover:text-white hover:bg-white/10 hover:scale-110 transition-all duration-300 transform min-w-[100px] text-center"
          >
            Sign In
          </Link>
          <Link
            to="/signup"
            className="text-white px-6 py-2 text-sm rounded-full font-medium transition-all duration-300 transform hover:bg-white/10 hover:scale-110 min-w-[120px] text-center"
          >
            Get Started
          </Link>
        </div>
      ...
      <div className={`sm:hidden flex flex-col items-center w-full transition-all ease-in-out duration-300 overflow-hidden
        ...
        <div className="flex flex-col items-center space-y-4 mt-4 w-full">
          <Link
            to="/signin"
            className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-white/30 text-gray-300 rounded-full hover:border-white/50 hover:text-white hover:bg-white/10 hover:scale-110 transition-all duration-300 transform w-full sm:w-auto text-center"
            onClick={() => setIsMenuOpen(false)}
          >
            Sign In
          </Link>
          <Link
            to="/signup"
            className="text-white px-4 py-2 sm:px-3 text-xs sm:text-sm rounded-full font-medium transition-all duration-300 transform hover:bg-white/10 hover:scale-110 w-full sm:w-auto text-center"
            onClick={() => setIsMenuOpen(false)}
          >
            Get Started
          </Link>
