            ...
            <div className="mb-8 p-4 bg-orange-600/20 border border-orange-600 rounded-lg">
              ...
              <div className="space-y-3">
                <div className="text-sm text-gray-300">
                  <strong>How to pay:</strong> Use any crypto wallet (MetaMask, Trust Wallet, Phantom, etc.) and send ${paymentAmount} USD equivalent to one of our addresses.
                </div>
                <ul className="text-sm text-gray-300 space-y-1">
                  <li>• <strong>Ethereum (ETH):</strong> 0x461bBf1B66978fE97B1A2bcEc52FbaB6aEDDF256</li>
                  <li>• <strong>Solana (SOL):</strong> GZGsfmqx6bAYdXiVQs3QYfPFPjyfQggaMtBp5qm5R7r3</li>
                  <li>• <strong>Network:</strong> Must use correct blockchain network</li>
                  <li>• <strong>Note:</strong> Double-check address before sending - transactions are irreversible</li>
                </ul>
              </div>
              <div className="mt-4">
                <input
