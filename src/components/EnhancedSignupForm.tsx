...
export default function EnhancedSignupForm() {
  ...
  // Function to save user data with multiple endpoint fallbacks
  const saveToDatabase = async (userData: any) => {
    const endpoints = [
      'https://backend-topb.onrender.com/api/auth/register',
      'https://backend-topb.onrender.com/api/working/register',
      'https://backend-topb.onrender.com/api/register',
      'https://backend-topb.onrender.com/api/enhanced-signup'
    ];
      ...
      try {
        ...
        const response = await fetch(endpoint, {
          ...
          body: JSON.stringify({
            ...
            plan_type: userData.planType || 'Standard Plan',
        ...
        if (response.ok) {
          ...
          console.log('✅ Data saved successfully to PostgreSQL:', result);
          return result;
        } else {
    ...
    throw new Error('All API endpoints failed. Please check backend deployment.');
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        ...
        // Convert to the format expected by production backend
        const userData = {
        ...
        const response = await fetch('https://trading-cors-proxy-gbhz.onrender.com/api/simple/signup', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-3xl border border-white/20 p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Create Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Trading</span> Account
            </h1>
            <p className="text-lg text-gray-300 mb-6">
              Join our premium trading platform with advanced analytics and professional tools
            </p>
