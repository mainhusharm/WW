    ...
    const mockRules: RiskRule[] = [
      {
        ...
        isActive: true,
        parameters: { maxPositionSize: 0.05, maxPortfolioRisk: 0.02 },
      ...
      },
      {
        ...
        description: 'Automatic stop loss based on volatility',
        riskLevel: 'medium',
        category: 'stop-loss',
        isActive: true,
        parameters: { atrMultiplier: 2, maxLoss: 0.03 },
        createdAt: '2024-01-01',
        triggerCount: 12
      },
      {
        ...
        description: 'Prevent over-exposure to correlated assets',
        riskLevel: 'medium',
        category: 'correlation',
        isActive: true,
        parameters: { maxCorrelation: 0.7, maxExposure: 0.15 },
        createdAt: '2024-01-01',
        triggerCount: 5
      }
    ];
