		...
		>
			...
			<div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
				<div className="text-center">
					<p className="text-sm font-light tracking-widest text-white/60 uppercase mb-4">
					...
					>
						Master Your Funded Account Journey
					</h1>
					<p
						ref={pRef}
					...
					>
						<Link
							to="/membership"
							className="group relative px-8 py-4 rounded-full bg-gradient-to-r from-white/10 to-white/5 border border-white/[0.1] hover:border-white/[0.2] transition-all duration-300 backdrop-blur-sm"
						>
