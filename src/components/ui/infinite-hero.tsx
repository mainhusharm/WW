...
function ShaderPlane({
	...
	useFrame((state) => {
		...
		if (frameCount.current % 3 === 0 && meshRef.current) {
...
export default function InfiniteHero() {
	...
	return (
		<div
			ref={rootRef}
			className="relative h-[120vh] w-full overflow-hidden bg-black text-white"
		>
			...
			<div className="relative z-10 flex h-[120vh] w-full items-start justify-center px-6 pt-96">
