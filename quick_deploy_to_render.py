...
- Comprehensive signal statistics"""
    ...
    print("=" * 50)
    print("")
    print("🌐 Your backend URL: https://backend-ox9b.onrender.com")
    ...
    print("curl https://backend-ox9b.onrender.com/healthz")
    print("curl https://backend-ox9b.onrender.com/api/signals/admin")
    print("curl https://backend-ox9b.onrender.com/api/signals/stats")
    print("")
