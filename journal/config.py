...
class Config:
    ...
    SUPABASE_URL = os.getenv('SUPABASE_URL', 'https://jxtgdlydaitemlorrhin.supabase.co')
    SUPABASE_ANON_KEY = os.getenv('SUPABASE_ANON_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp4dGdkbHlkYWl0ZW1sb3JyaGluIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjYzMTkzMjIsImV4cCI6MjA4MTg5NTMyMn0.MresWgaeB9dtHI86NOahbWkEpHqiRT_TlEl04n4n7F0')
    SUPABASE_SERVICE_ROLE_KEY = os.getenv('SUPABASE_SERVICE_ROLE_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imp4dGdkbHlkYWl0ZW1sb3JyaGluIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2NjMxOTMyMiwiZXhwIjoyMDgxODk1MzIyfQ.gvpKQEy23DRr8v9lidRYFBLWA2g8o0Ws-nvDAKDr4t0')

    # Dual Database Configuration
    DUAL_DB_SYNC_ENABLED = os.getenv('DUAL_DB_SYNC_ENABLED', 'true').lower() == 'true'
    SUPABASE_PRIMARY = os.getenv('SUPABASE_PRIMARY', 'true').lower() == 'true'
    POSTGRES_BACKUP = os.getenv('POSTGRES_BACKUP', 'true').lower() == 'true'
